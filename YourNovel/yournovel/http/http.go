...
func initGetRouterApi2(engine *gin.Engine) {

	engine.GET("search_api/chapter", middleware.RequestMiddlewareWrapper(novelChapterApi, middleware.MyMiddlewareOption{
		IsAuth: false,
	}))

	engine.GET("search_api/search", middleware.RequestMiddlewareWrapper(novelSearchApi, middleware.MyMiddlewareOption{
		IsAuth: false,
	}))

	engine.GET("search_api/content", middleware.RequestMiddlewareWrapper(novelContentApi, middleware.MyMiddlewareOption{
		IsAuth: false,
	}))
}
